...
$page->add_script ("<script>document.createElement('video');document.createElement('audio');document.createElement('track');</script>\n");
$page->add_script ('/apps/courses/js/video.min.js');
$page->add_script ("<script>videojs.options.flash.swf = '/apps/courses/css/video-js.swf';</script>\n");
